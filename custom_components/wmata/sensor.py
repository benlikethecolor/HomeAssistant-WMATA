...
async def async_setup_entry(
    ...
    coordinator: WmataCoordinator = hass.data[DOMAIN][
    ...
    sensors = [
        TrainSensor(coordinator, device)
...
class TrainSensor(CoordinatorEntity, SensorEntity):
    """Implementation of a sensor."""

    def __init__(self, coordinator: WmataCoordinator, device: Device) -> None:
        """Initialise sensor."""
